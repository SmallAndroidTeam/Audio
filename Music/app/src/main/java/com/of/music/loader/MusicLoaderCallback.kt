...
import com.of.music.util.onlineUtil.ParseUtils
 ...
 * @date 2018/7/11
 */
class MusicLoaderCallback(private val context: Context, private val callback: ValueCallback<List<Imusic>>) : LoaderManager.LoaderCallbacks<Cursor> {
    private val musicList = mutableListOf<Imusic>()

    override fun onCreateLoader(id: Int, args: Bundle?): Loader<Cursor> {
        return MusicCursorLoader(App.sContext)
    }
