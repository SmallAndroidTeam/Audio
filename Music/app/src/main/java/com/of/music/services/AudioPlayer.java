...
import com.of.music.Application.Notifier;
import com.of.music.Application.Preferences;
import com.of.music.broadcastReceiver.NoisyAudioStreamReceiver;
 ...
 */
public class AudioPlayer implements OnPlayerEventListener{
    ...
    public void init(Context context) {
        ...
        mediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            ...
            public void onCompletion(MediaPlayer mp) {
                try {
                    mp.setDataSource(musicList.get(state + 1).getPath());
                }catch (IOException e){
                    e.printStackTrace();
                }
            }
    ...
    public void play(int position) {
        ...
        try {
          ...
          //  MediaSessionManager.get().setupMediaSession();
...
//            MediaSessionManager.get().updatePlaybackState();
    ...
    public void delete(int position) {
        ...
        Imusic music = musicList.remove(position);
        DBManager.get().init(App.sContext);
    ...
    public void startPlayer() {
        ...
        if (audioFocusManager.requestAudioFocus()) {
            ...
            //MediaSessionManager.get().updatePlaybackState();
            App.sContext.registerReceiver(noisyReceiver, noisyFilter);
    ...
    public void pausePlayer(boolean abandonAudioFocus) {
        ...
        //MediaSessionManager.get().updatePlaybackState();
        App.sContext.unregisterReceiver(noisyReceiver);
