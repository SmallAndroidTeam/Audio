...
*/
public class ImusicDao extends AbstractDao<Imusic, Long> {

    public static final String TABLENAME = "SystemMessage";

    /**
     * Properties of entity Imusic.<br/>
    ...
    public ImusicDao(DaoConfig config) {
        super(config);
    }
    
    public ImusicDao(DaoConfig config, DaoSession daoSession) {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, Imusic entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, Imusic entity) {
        stmt.clearBindings();
    ...
    @Override
    public Imusic readEntity(Cursor cursor, int offset) {
        Imusic entity = new Imusic( //
    ...
    @Override
    public void readEntity(Cursor cursor, Imusic entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(Imusic entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(Imusic entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(Imusic entity) {
